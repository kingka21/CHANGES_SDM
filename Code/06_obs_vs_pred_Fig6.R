...
output<-readRDS("Data/output/output_model2_secchi_fold5_lakes.rds") #change this output for each fold 
...
cont_test<-test5# just change this input each time to match fold 
